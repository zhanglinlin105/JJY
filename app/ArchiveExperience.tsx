...
function Glyph({ name }: { name: "orbit" | "reset" | "arrow" | "book" | "close" }) {
  const paths = {
...
export default function ArchiveExperience({ archive }: { archive: ReactNode }) {
  ...
  return (
    <div className="experience" data-chapter={chapter}>
      <a className="skipLink" href="#three-scene">跳到三维展馆</a>
      <div className="sceneHost" id="three-scene" ref={canvasHost} role="region" aria-label="三维光影档案馆，拖动旋转视角，滚轮缩放。方向键切换展区，加减键缩放，R 重置。" tabIndex={0} />
      ...
      <noscript><style>{`.experienceHeader,.exhibitionOverlay,.sceneLoading,.sceneHost,.sceneVignette{display:none!important}.archiveDialog{display:block!important;position:relative!important;max-height:none!important;height:auto!important;width:100%!important;margin:0!important;border:0!important}.archiveDialogHeader{display:none!important}.experience{height:auto!important;overflow:visible!important}body{overflow:auto!important}`}</style></noscript>
